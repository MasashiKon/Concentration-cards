...
function setGame() {
    ...
    if(neededHeight > window.innerHeight - cardHeight - 20) {
    ...
    for(let i = 0; i < cardElements.length; i++) {
        ...
        },
        {
            ...
            top: numOfAnimals === 9 || numOfAnimals === 10 ? regendHeight + rowCardOn  * cardHeight + rowCardOn * betweenCard + cardHeight / 16: regendHeight + rowCardOn  * cardHeight + rowCardOn * betweenCard + cardHeight / 16,
        }, i * 0.05);
    }
                            ...
                            matchTimeLine
                                ...
                                .then(() => {
                                    if(gameState.matchedPair === gameState.pickedAnimals.length) {
                                        ...
                                        compText.style.top = `${containerHeight / 2 + compText.innerHeight}px`;
